...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::scan_orphan_takes,
            commands::import_orphan_take,
            commands::discard_orphan_take,
            commands::list_scenes,
            commands::create_scene,
            commands::rename_scene,
            commands::duplicate_scene,
            commands::delete_scene,
            commands::add_scene_source,
            commands::remove_scene_source,
            commands::set_scene_source_device,
            commands::list_capture_devices,
            commands::set_scene_source_defaults,
            commands::reorder_scene_source,
            commands::set_scene_transcript_source,
